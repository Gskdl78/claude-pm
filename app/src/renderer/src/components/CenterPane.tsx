...
export function CenterPane({ tab, onTab, status, launchSeq, onRestart, path, stageDocs, selectedDoc, onSelectDoc, docsRevision, onNotice, fontSize }: Props) {
  ...
  return (
    <section className="center">
      ...
      <div className="center-body">
        <Terminal visible={tab === 'terminal'} status={status} launchSeq={launchSeq} onRestart={onRestart} fontSize={fontSize} />
